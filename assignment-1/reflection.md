...
## The Bad and Ugly
- Due problems with GitHub, Alex (my subteam partner) had to rename the file where we were working with, so the trace to my contribution was half lost.
- After other team members reviewed our work, IS processed Erik's comments leaving short explanations about the actions I took. At last controlling the end results I discover pieces of my work were removed, and nobody leave any comment about.
