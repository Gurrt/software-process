...
Comparison against successful companies:
...
From our earlier analysis, we know that 'political' factors had a large impact on the problems that surrounded HealtCare.gov [cite]. These problems are not isolated to HealtCare.gov, in fact many government systems are a victim of similar problems [14]. Political problems are not reserved for government systems only, though. It does not matter whether a company is small or big, political activities are perpetrated everywhere.
