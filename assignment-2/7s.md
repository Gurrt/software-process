...
- They like cross-pollination instead of 'standarization', in order to spread knowledge, trends and tools between squads. It does not break the principal of 'issolated missions' because cross-pollination is used to stread the uses of tools like github for example. 
