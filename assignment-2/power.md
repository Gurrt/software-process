...
####Intervention
The question that you could ask after reading the previous part is: why does someone does not intervine and ends the project or replaces contractors? This is not a question that I can answer, but I can speculate about this with the information we have.
...
My point of view is that it is not. CMS has to do what the Obama administration tells them to do and follow their political agenda. Even dispite all warnings [1] [3] and even if it is impossible to get it done. Should not it be possible for the CMS to say to politican: “no, we can’t”? 
